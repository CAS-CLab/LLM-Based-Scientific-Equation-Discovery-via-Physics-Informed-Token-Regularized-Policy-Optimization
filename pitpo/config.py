...
class Config:
   ...
   """
    ...
    llm_server_url: str = "http://127.0.0.1:5000/completions"
    # Optional: vLLM inference URL used after fine-tuning; if empty, falls back to llm_server_url
    llm_server_url_finetuned: Optional[str] = None
